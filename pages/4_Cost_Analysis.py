...
with tab1:
    ...
    # rent data by neighborhood — sourced from Zumper (Feb 2026) and RentCafe (Jan 2026)
    ...
    neighborhoods = {
        "Uptown (Near Campus)": {
            ...
            "commute_uptown": "5-10 min walk",
            "commute_downtown": "35-40 min streetcar",
            "walkability": "Excellent",
            "grocery_access": "Whole Foods, Rouses",
            "pros": ["Walking distance to uptown campus", "Many student housing options", "Walkable neighborhood"],
            "cons": ["Long commute to downtown campus", "Higher rent for 2-bed", "Limited parking"],
        ...
        "Garden District": {
            ...
            "commute_uptown": "15-20 min shuttle",
            "commute_downtown": "30-40 min streetcar/bus",
            "walkability": "Good",
            "grocery_access": "Rouses, Whole Foods",
            "pros": ["Beautiful historic area", "Reasonable commute to both campuses", "Good restaurants"],
            "cons": ["Need shuttle/bike for uptown campus", "Tourist area"],
            "source": "Zumper Feb 2026"
        },
        "Mid-City": {
            ...
            "commute_uptown": "25-30 min bus/car",
            "commute_downtown": "15-20 min bus/car",
            "walkability": "Moderate",
            "grocery_access": "Walmart, Rouses, Costco",
            "pros": ["More space", "Closer to downtown campus", "Near City Park"],
            "cons": ["Long commute to uptown campus", "Need reliable transport", "Variable by block"],
        ...
        "French Quarter/CBD": {
            ...
            "commute_uptown": "30-40 min streetcar",
            "commute_downtown": "10-15 min walk/bus",
            "walkability": "Excellent",
            "grocery_access": "Small markets, Rouses CBD",
            "pros": ["Walking distance to downtown campus", "Very walkable", "Streetcar access"],
            "cons": ["Most expensive", "Very loud", "Long commute to uptown campus", "Tourist crowds"],
            "source": "RentCafe Jan 2026"
        }
    }
    ...
    for name, data in neighborhoods.items():
        comparison_data.append({
            ...
            "Commute → Uptown": data['commute_uptown'],
            "Commute → Downtown": data['commute_downtown'],
    ...
    for idx, (name, data) in enumerate(neighborhoods.items()):
        with cols[idx % 2]:
            with st.expander(f"**{name}**", expanded=False):
                ...
                st.markdown(f"""
**Location Details:**
- Commute to Uptown Campus: {data['commute_uptown']}
- Commute to Downtown Campus: {data['commute_downtown']}
- Grocery Access: {data['grocery_access']}
...
with tab2:
    ...
    # user enters their 1-bed rent, we scale up for larger units
    scenarios = {
        "Living Alone (1-bed)": {
            "rent": example_rent,
