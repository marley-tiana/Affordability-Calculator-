...
# Uber-style pricing (New Orleans rates)
...
# Average speed in New Orleans (mph)
AVERAGE_SPEED = 25

# =============================================================================
# GEOCODING FUNCTIONS (FREE!)
# =============================================================================
...
def geocode_address(address):
    ...
    import re
    try:
        # Only append New Orleans if no state/city already specified
        ...
        # Second attempt: strip to just street + city
