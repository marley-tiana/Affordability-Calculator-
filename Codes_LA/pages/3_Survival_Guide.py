...
# These are independent lifestyle tips — NOT deducted from the calculator's day60 cost.
# The calculator covers housing + transport only. These tips cover groceries,
# transport habits, and furniture — separate budget categories.
# =============================================================================
...
# Show total potential savings upfront
...
if st.session_state.get("calculation_results"):
    ...
    # Only show transport savings if user chose an expensive transport option
