"""
Professional navigation component for multi-page Streamlit app.
Uses ONLY native Streamlit components - no unsafe_allow_html.
...
def render_top_navigation():
    """
    Render a professional navigation bar using native Streamlit components.
    Works in ALL browsers including Safari.
    """
    pages = get_page_config()

    # Navigation bar using columns of buttons
